...
//  NHPlayKit
//
//  Created by nenhall on 2019/10/18.
//  Copyright © 2019 nenhall. All rights reserved.
//

#ifndef NHAVPlayDefine_h
#define NHAVPlayDefine_h
...
#ifdef DEBUG
#define NSLog(fmt, ...) NSLog((@"[NHPlay] %s " fmt), __PRETTY_FUNCTION__, ##__VA_ARGS__);
#else
#define NSLog(...)
#endif
